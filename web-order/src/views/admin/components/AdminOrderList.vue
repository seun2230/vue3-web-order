...
export default {
  ...
  created() {
    this.$store.commit("admin/getOrderList")
  },
  computed: {
    ...mapState('admin', ['orderList']),
    pageCount() {
      let listLength = this.orderList.length,
  ...
  methods: {
    ...
    modifyRow(index) {
      let modify_id = this.orderList[index]
